<template>
  <q-header class="bg-white text-grey-8" height-hint="56">
    <q-toolbar>
      ...
      <q-avatar>
        <q-img scr="https://cdn.quasar.dev/img/avatar1.jpg" />
      </q-avatar>
      <q-toolbar-title shrink class="text-subtitle1 text-weight-bolder"
        >Tommy App</q-toolbar-title
      >
      <q-space />
      <div class="search row items-cemter">
        <q-input
          class="col-grow"
          outlined
          square
      ...
      <q-space />
      <q-btn flat round icon="more_vert" class="q-mr-sm"></q-btn>
      <q-btn
        outline
        rounded
        color="primary"
